...
export interface ErrorResponse {
     ...
     * @link https://mailchimp.com/developer/marketing/docs/errors/
     */
    type: string;
    /**
...
export namespace batches {
    ...
    type BatchStatus  = 'pending' | 'preprocessing' | 'started' | 'finalizing' | 'finished'
    ...
    interface GetBatchListOpts {
        /**
         * A List of fields to return. Reference parameters of sub-objects with dot notation.
         */
        fields?: string[]
        /**
         * A List of fields to exclude. Reference parameters of sub-objects with dot notation.
         */
        excludeFields?: string[]
        /**
         * The number of records to return. Default value is 10. Maximum value is 1000
     ...
     * @doc https://mailchimp.com/developer/marketing/api/batch-operations/start-batch-operation/
     */
    function list(opts?: GetBatchListOpts): Promise<BatchListResponse>
    ...
    interface BatchOperation {
        ...
        /**
         * A string containing the JSON body to use with the request. Example body: "{\"title\":\"Test\"}"
         */
        body: string
        /**
    ...
    interface StartBatchOperationBody {
        /**
     ...
     * @param {StartBatchOperationBody} body 
     */
    function start(body: StartBatchOperationBody): Promise<Batch>


    interface GetBatchOpts {
        /**
         * A List of fields to return. Reference parameters of sub-objects with dot notation.
         */
        fields?: string[]
     ...
     * @param {GetBatchOpts} opts Optional parameters
     * @returns {Promise<Batch>} The status of a batch request
     */
